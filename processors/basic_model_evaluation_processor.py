...
class BasicModelEvaluationProcessor:
    ...
    def process(self, X_test, y_test):
        ...
        self.__generate_results__(len(X_test), score, timestamp_utc)

    # -------------------------------------------------------------------------
    def __generate_results__(self, test_size: int, score, timestamp_utc):
        ...
        report = report + f"test file count: {test_size}\n"
